window.onload=function(){
    ...
    let dot1=document.querySelectorAll(".content ul li .pages .ctrile");
    let leftb=document.querySelector(".content ul li .leftb");
    let rightb=document.querySelector(".content ul li .rightb");
    ...
    function frist(hook,dot1,leftb,rightb,widtha){
        ...
        function moveLeft() {
            ...
            dot1[current].classList.remove("activd");
            dot1[down].classList.add("activd");
            current=down;
        }
